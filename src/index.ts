...
const end03: Endereco = new Endereco('CEP: 49.300-000', 'Rua: C', 63, 'Bairro: Padre Pedro', 'Cidade: Tobias Barreto', 'Estado: Sergipe');
...
const nota05: Nota = new Nota(6, 4);
const nota06: Nota = new Nota(8, 2);
...
const disc03: Disciplina = new Disciplina("Construção de Sites I", 72, [nota05, nota06]);
...
const werik: Aluno = new Aluno("Masculino", "123.654.789-66", "Werik", "Jahell", 66, true, [end03], ["79 9.8834-3565"], "RH", SituacaoAluno.CONCLUIDO, [disc03]);
...
console.log(werik.disciplinas[0].calcularMediaAritmetica());
console.log(werik.disciplinas[0].calcularMediaPonderada());


hesnan.submeterProjetoPesquisa();
hesnan.submeterProjetoExtensao();

jahell.submeterProjetoPesquisa();
jahell.submeterProjetoExtensao();

werik.submeterProjetoPesquisa();
werik.submeterProjetoExtensao();
